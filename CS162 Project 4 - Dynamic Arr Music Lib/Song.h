...
public:
	...
	//accessor functions
	void getTitle(char title[]) const; //const at the end of this function specifies that the function cannot modify the member variables of the variable type (class) Song.
									   ...
									   //*NOTE: a constant member function of a class can ONLY call other constant member functions of that class. So be careful when you make a member function constant.//is this true? found different answers on StackExchange...
